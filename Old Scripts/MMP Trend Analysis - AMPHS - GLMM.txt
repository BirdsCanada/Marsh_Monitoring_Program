...
#
# If you are familiar with the Bayesian script, there are some subtle differences to the GLMM analysis
...
# filename for the exported results
  fileName <- "Trend Amphs Analysis - GLMM"	# NAME OF OUTPUT FILE (.csv)  			(use this file for further summaries)
...
# Make your OWN species list
  splist2 <- c('CHFR','AMTO','NLFR','SPPE','BULL','GRFR','GRTR','PIFR','WOFR','CGTR','FOTO','BCFR','MIFR','GPTO')
