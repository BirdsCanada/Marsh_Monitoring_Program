...
#
# The main input is "Birdstns_noobserve.csv" which is a species table built in another R script	
...
#	- what types of models to run (see fl table below) (e.g., logisitic vs. poisson, indices
#		vs. trends, subsetting by basins, bcrs, etc.
#		The DEFAULT is to run ALL which takes a LONG LONG time (maybe two days in 2011)
#	- species:	- default is to run ALL species for poisson, and only those species
#			with > 90% of counts a count of "one" (e.g., binary) for logisitic regression
#
#
...
# filename for the exported results
  fileName <- "Trend Birds 2010 APR24TH"
...
FALSE,	"~ year + log(nStations)",		"poisson", 	"~route",			"GreatLakes='1'",	allspecies 
,FALSE,	"~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"GreatLakes='1'",	allspecies 	
,FALSE,	"~ year*basin + log(nStations)-1 -year","poisson", 	"~route",			"GreatLakes='1'",	allspecies 
,FALSE,	"~ year",				"categorical", 	"~route",			"GreatLakes='1'",	splist2 
,FALSE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"GreatLakes='1'",	splist2 	
,FALSE,	"~ year*basin -1 -year",		"categorical", 	"~route",			"GreatLakes='1'",	splist2 
,FALSE,	"~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"basin='H'",		allspecies 	
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"basin='H'",		splist2 	
,FALSE, "~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"basin='O'",		allspecies 	
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"basin='O'",		splist2 	
,FALSE, "~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"basin='M'",		allspecies 	
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"basin='M'",		splist2 	
,FALSE, "~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"basin='E'",		allspecies 	
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"basin='E'",		splist2 	
,FALSE, "~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"basin='S'",		allspecies 	
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"basin='S'",		splist2 	
,FALSE, "~ year + log(nStations)",		"poisson", 	"~route",			"provstat = 'ON'",	allspecies 
,FALSE, "~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"provstat = 'ON'",	allspecies 	
,TRUE,	"~ year",				"categorical", 	"~route",			"provstat = 'ON'",	splist2 
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"provstat = 'ON'",	splist2 	
,FALSE, "~ year + log(nStations)",		"poisson", 	"~route",			"provstat='ON' AND bcr='13'",	allspecies 
,FALSE, "~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"provstat='ON' AND bcr='13'",	allspecies 	
,TRUE,	"~ year",				"categorical", 	"~route",			"provstat='ON' AND bcr='13'",	splist2 
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"provstat='ON' AND bcr='13'",	splist2 	
,FALSE, "~ year + log(nStations)",		"poisson", 	"~route",			"bcr='12'",		allspecies 
,FALSE,	"~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"bcr='12'",		allspecies 	
,TRUE,	"~ year",				"categorical", 	"~route",			"bcr='12'",		splist2 
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"bcr='12'",		splist2 	
,FALSE, "~ year + log(nStations)",		"poisson", 	"~route",			"bcr='23'",		allspecies 
,FALSE, "~ as.factor(year)  + log(nStations) -1","poisson", 	"~route",			"bcr='23'",		allspecies 	
,TRUE,	"~ year",				"categorical", 	"~route",			"bcr='23'",		splist2 
,TRUE,	"~ as.factor(year) -1",			"categorical", 	"~route",			"bcr='23'",		splist2 	
)
